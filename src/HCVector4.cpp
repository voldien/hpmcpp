...
float Vector4::squaredLength(void) const {
	return hpm_vec4_lengthsqurefv(&this->e);
}

void Vector4::makeUnitVector(void) {
...
float Vector4::minComponent(void) const{
	return hpm_vec4_min_compfv(&this->e);
}

float Vector4::maxComponent(void) const {
	return hpm_vec4_max_compfv(&this->e);
}

float Vector4::maxAbsComponent(void) const {
