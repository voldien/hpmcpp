...
Quaternion::Quaternion(const Quaternion &quaternion) { *this = quaternion; }

Quaternion::Quaternion(float w, float x, float y, float z) { this->set(w, x, y, z); }

Quaternion::Quaternion(float pitch, float yaw, float roll) { *this = createQuaternionOfAxis(pitch, yaw, roll); }

void Quaternion::set(float w, float x, float y, float z) { hpm_quat_setf(&this->e, w, x, y, z); }
...
void Quaternion::setW(float w) { hpm_quat_setwf(this->e, w); }
void Quaternion::setX(float x) { hpm_quat_setxf(this->e, x); }
void Quaternion::setY(float y) { hpm_quat_setyf(this->e, y); }
void Quaternion::setZ(float z) { hpm_quat_setzf(this->e, z); }
...
Vector3 Quaternion::up(void) const { return this->getVector(Vector3::up()); }

Vector3 Quaternion::forward(void) const { return this->getVector(Vector3::forward()); }
...
float Quaternion::magnitude(void) const { return hpm_quat_lengthfv(&this->e); }

float Quaternion::magnitudeSquared(void) { return hpm_quat_lengthsqurefv(&this->e); }
...
namespace LIBHPM {
	...
	bool operator==(const Quaternion &v1, const Quaternion &v2) { return (bool)hpm_vec4_eqfv(&v1.e, &v2.e); }
	bool operator!=(const Quaternion &v1, const Quaternion &v2) { return (bool)hpm_vec4_neqfv(&v1.e, &v2.e); }
	float dot(const Quaternion &lh, const Quaternion &rh) { return hpm_quat_dotfv(&lh.e, &rh.e); }
} // namespace LIBHPM

float Quaternion::getPitch(void) const { return hpm_quat_pitchfv(&this->e); }

float Quaternion::getYaw(void) const { return hpm_quat_yawfv(&this->e); }

float Quaternion::getRoll(void) const { return hpm_quat_rollfv(&this->e); }

void Quaternion::getEular(float *pitch, float *yaw, float *roll) const { hpm_quat_eularfv(&this->e, pitch, yaw, roll); }
...
Quaternion Quaternion::createQuaternionOfAxis(float pitch, float yaw, float roll) {
	Quaternion quat;
...
Quaternion Quaternion::lerp(const Quaternion &from, const Quaternion &to, float time) {
	Quaternion quat;
	hpm_quat_lerpfv(&from.e, &to.e, time, &quat.e);
	return quat;
}

Quaternion Quaternion::slerp(const Quaternion &q1, const Quaternion &q2, float time) {
	Quaternion quat;
